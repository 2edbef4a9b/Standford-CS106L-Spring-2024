...
public:
     ...
     *
     * Parameters: const l-value reference to type K, the key we are looking for.
     * Return value: const_iterator to the K/M element with given key.
     *
     * Usage:
     *      auto iter = cmap.find(4);
     *      std::cout << iter->second; // prints whatever 4 was mapped to.
     *
     * Complexity: O(1) amortized average case, O(N) worst case, N = number of elements
     */
    ...
    /*
     * Copy constructor.
     * Creates a new HashMap as a copy of the parameter.
     *
     * Usage:
     *      HashMap map1;
     *      HashMap map2(map1);
     *
     * Complexity: O(N), N = number of elements in rhs
     */
    HashMap(const HashMap& rhs);

    /*
     * Copy assignment operator.
     * Replaces the contents of the HashMap with a copy of the parameter.
     * 
     * Usage:
     *      HashMap map1, map2;
     *      map2 = map1;
    ...
    /*
     * Move constructor.
     * Creates a new HashMap by moving the contents of the parameter.
     * 
     * Usage:
     *      HashMap map1;
     *      HashMap map2(std::move(map1));
     * 
     * Complexity: O(1)
     */
     ...
     * Replaces the contents of the HashMap by moving the contents of the parameter.
     * 
     * Usage:
     *      HashMap map1, map2;
     *      map2 = std::move(map1);
...
private:
    ...
    /*
     * Creates a const_iterator that points to the element curr->value.
     */
